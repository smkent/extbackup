...
class TestProperties(object):
    ...
    def test_hostname_bad(self, mock_gethostname):
        mock_gethostname.return_value = None
        backup = ExternalBackup()
        with pytest.raises(Exception):
            assert backup.hostname

    def test_target_drive_not_mounted(self, mock_chmod, mock_mkdir,
    ...
    def test_target_exists(self, dir_exists, mock_chmod, mock_mkdir,
